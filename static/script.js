    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 3, , 4]);
                    return [4 /*yield*/, fetch("".concat(localhostAddress, "/").concat(id), {
                            method: "PUT",
                            headers: {
                                "Content-Type": "application/json",
                            },
                ...
                case 1:
                    ...
                    if (todoList.length == 0) {
                        ...
                        todoList.forEach(function (todo) {
                            todoListContainer.innerHTML += "\n          <div class=\"todo\">\n            <span\n              id=\"todoname\"\n              style=\"text-decoration:".concat(todo.completed ? "line-through" : "", "\"\n              data-iscomplete=\"").concat(todo.completed, "\"\n              data-id=\"").concat(todo.id, "\"\n            >\n              ").concat(todo.title, "\n              </span>\n  \n              <div class=\"actions\">\n                  <button data-id=").concat(todo.id, " class=\"edit\">\n                      <i class=\"fas fa-edit\"></i>\n                  </button>\n                  <button data-id=").concat(todo.id, " class=\"delete\">\n                  <i class=\"far fa-trash-alt\"></i>\n                  </button>\n              <div>\n              \n          </div>\n          ");
                        });
                        deleteTaskButton();
                        editTaskTitleButton();
